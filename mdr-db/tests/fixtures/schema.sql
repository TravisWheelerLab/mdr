...
ALTER TABLE ONLY public.md_simulation_collection
    ADD CONSTRAINT md_simulation_collec_simulation_id_d01829fc_fk_md_simula FOREIGN KEY (simulation_id) REFERENCES public.md_simulation(id) DEFERRABLE INITIALLY DEFERRED;
